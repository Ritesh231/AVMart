                ...
                <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <div className="flex items-center gap-3 border-l pl-4 md:pl-6 border-slate-200">
                        ...
                        <div className="hidden lg:block">
                            <h4 className="text-sm font-bold text-brand-navy leading-none">Admin User</h4>
                            <p className="text-[11px] text-brand-gray mt-1 uppercase tracking-wider">admin@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
