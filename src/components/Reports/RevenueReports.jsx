...
function RevenueReport() {
    ...
    const exportToExcel = () => {
        ...
        const rows = [...orderRows, ...productRows];
        if (!rows.length) return;
        downloadBlob(buildCsv(orderRows.length ? orderRows : productRows),
    ...
    const exportToDoc = () => {
        ...
        downloadBlob(buildHtmlTable(orderRows, "Revenue Report"),
    ...
    const exportToPdf = () => {
        ...
        printWindow.document.write(buildHtmlTable(orderRows, "Revenue Report"));
